...
<tr><td align="left">Name</td> <td><input name="name" type="text"> </td></tr> 
<tr><td align="left">Email</td> <td><input name="email" type="text"> </td></tr> 
<tr><td colspan="2"><center><input name="reset" type="reset" value="Reset"> <input name="submit" type="submit" value="Submit"></center></td></tr></table>
    ...
    },
    {
        ...
        res => q(<form action="00generate.t" method="GET"><input name="_submitted" type="hidden" value="1"><input name="_sessionid" type="hidden" value=""><table>
<tr><td align="left">Upper</td> <td><input name="Upper" type="text" value="1"> </td></tr> 
<tr><td align="left">Case</td> <td><input name="Case" type="text" value="0"> </td></tr> 
<tr><td colspan="2"><center><input name="reset" type="reset" value="Reset"> <input name="submit" type="submit" value="Submit"></center></td></tr></table>
</form>),
    },
    {
        ...
        res => q(<form action="00generate.t" method="GET"><input name="_submitted" type="hidden" value="1"><input name="_sessionid" type="hidden" value=""><table>
<tr><td align="left">First Name</td> <td><input name="first_name" type="text"> </td></tr> 
<tr><td align="left">Last Name</td> <td><input name="last_name" type="text"> </td></tr> 
<tr><td colspan="2"><center><input name="submit" type="submit" value="Update"></center></td></tr></table>
</form>),
    },
    {
...
<html><head><title>00generate</title></head><body bgcolor="black"><h3>00generate</h3><form action="00generate.t" method="GET"><input name="_submitted" type="hidden" value="1"><input name="_sessionid" type="hidden" value=""><table>
<tr><td align="left">First Name</td> <td><input name="first_name" type="text"> </td></tr> 
<tr><td align="left">Last Name</td> <td><input name="last_name" type="text"> </td></tr> 
<tr><td colspan="2"><center><input name="submit" type="submit" value="Update"></center></td></tr></table>
</form></body></html>
...
<tr><td align="left"><b>Email</b></td> <td><input name="email" type="text" value="nate@wiger.org">  <font size="-1">(name@host.domain)</font></td></tr> 
<tr><td align="left">First Name</td> <td><input name="first_name" type="text" value="Nate"> </td></tr> 
<tr><td colspan="2"><center><input name="reset" type="reset" value="Reset"> <input name="submit" type="submit" value="Submit"></center></td></tr></table>
</form>),
    },
    {
...
<tr><td colspan="2"><center><input name="reset" type="reset" value="Reset"> <input onClick="this.form.submit.value = this.value;" name="submit" type="submit" value="Update"><input onClick="this.form.submit.value = this.value;" name="submit" type="submit" value="Delete"><input onClick="this.form.submit.value = this.value;" name="submit" type="submit" value="Cancel"></center></td></tr></table>
</form>),
    },
    {
        # max it out, baby
...
<html><head><title>Econ 101</title></head><body bgcolor="white"><font face="arial,helvetica"><h3>Econ 101</h3><form action="/nowhere.cgi" method="PUT" name="econ"><input name="_submitted_econ" type="hidden" value="1"><input name="_sessionid" type="hidden" value=""><table>
<tr><td align="left"><font face="arial,helvetica">Supply</td> <td><font face="arial,helvetica"><select multiple name="supply" type="select"><option selected value="1">1</option><option selected value="2">2</option><option selected value="3">3</option><option selected value="4">4</option><option selected value="5">5</option></select> </td></tr> 
<tr><td align="left"><font face="arial,helvetica">Demand</td> <td><font face="arial,helvetica"><select multiple name="demand" type="select"><option selected value="6">6</option><option selected value="7">7</option><option selected value="8">8</option><option selected value="9">9</option><option selected value="0">0</option></select> </td></tr> 
<tr><td colspan="2"><font face="arial,helvetica"><center><input name="reset" type="reset" value="Reset"> <input name="submit" type="submit" value="Submit"></center></td></tr></table>
</form></body></html>
),
    },
    {
        ...
        res => q(<form action="00generate.t" method="GET"><input name="_submitted" type="hidden" value="1"><input name="_sessionid" type="hidden" value=""><table>
<tr><td align="left">Db Name</td> <td><input name="db:name" type="hidden">  </td></tr> 
<tr><td align="left">Db Type</td> <td><input name="db:type" type="hidden">  </td></tr> 
<tr><td align="left">Db Tab</td> <td><input name="db:tab" type="hidden">  </td></tr> 
<tr><td align="left">Ux User</td> <td><input name="ux:user" type="hidden">  </td></tr> 
<tr><td align="left">Ux Name</td> <td><input name="ux:name" type="hidden">  </td></tr> 
<tr><td colspan="2"><center></center></td></tr></table>
</form>),
    },
    {
        # single-line search thing ala Yahoo!
        opt => { fields => 'search', submit => 'Go', reset => 0 },
        res => q(<form action="00generate.t" method="GET"><input name="_submitted" type="hidden" value="1"><input name="_sessionid" type="hidden" value="">Search <input name="search" type="text">  <input name="submit" type="submit" value="Go"></form>),
    },
    {
